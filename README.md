...
1. Windows API 功能细分，几乎可以找到任何现成的 API 或其组合完成你的编程逻辑，这是好事(见下一条)；
2. Windows 做一个 mtr 简直太方便，比 Linux 封装 raw socket 方便得多，它有现成 IcmpSendEcho2 API，直接填表就行；
3. Windows 一旦出问题，除了自己调试，很难获得帮助，因为各人各见，没人正好碰到过你这个问题，碰到了算你幸运，但这也就不再是什么疑难杂症了；
4. Windows 官方代码和文档非常匮乏，野生资源更是门槛超高，不是圈内人很难获得帮助，看雪有内容，但门槛高，且群体偏狂妄，对初学者不友好；
5. Windwos 代码多，但多数不是自己写的，因为 Windows 重视框架；
6. Windows 问题虽然很难获得有效帮助，但有几个精通 Windows 的朋友是最大的财富，幸运的是，我有这样的朋友 :-)
